...
export default {
  ...
  methods: {
    onChange (val) {
       this.detail=[]
    let array=[
          {name:'座组件',quantity:'377.8',receiveQuantity:'43',jcblStr:'0',jc:''},
          {name:'合金结构钢圆钢',quantity:'42',receiveQuantity:'46',jcblStr:'0',jc:''},
          {name:'防托梁间隙样板',quantity:'319',receiveQuantity:'226',jcblStr:'0',jc:''},
          {name:'银亮钢丝',quantity:'295.5',receiveQuantity:'249',jcblStr:'0',jc:''},
      ]
   ...
   _clickName(){
    ...
    _fetchData() {
      var that = this;
       that.detail=[]
      let array=[
          {name:'银亮钢丝',quantity:'348.5',receiveQuantity:'310',jcblStr:'0',jc:''},
          {name:'座椅总成',quantity:'290',receiveQuantity:'245',jcblStr:'0',jc:''},
          {name:'自制混凝土',quantity:'389.5',receiveQuantity:'385',jcblStr:'0',jc:''},
