      ...
      <x-table class="tablelist" full-bordered>
        ...
        <tbody v-show="detail.length !== 0">
          <tr :class="{'vux-tap-active': true,'weui-cell_access': true}" v-for="(list,index) in detail" :key="index" 
            ...
            <td v-text="list.name" :style="nameSize" @click="_clickName"></td>
...
export default {
  ...
  methods: {
    onChange (val) {
       this.detail=[]
    let array=[
          {name:'C25',quantity:'400',receiveQuantity:'343',jcblStr:'0',jc:''},
          {name:'C20',quantity:'542',receiveQuantity:'460',jcblStr:'0',jc:''},
          {name:'C30',quantity:'429',receiveQuantity:'326',jcblStr:'0',jc:''},
          {name:'C40',quantity:'98',receiveQuantity:'89',jcblStr:'0',jc:''},
          {name:'C35',quantity:'155',receiveQuantity:'111',jcblStr:'0',jc:''},
      ]
   ...
   _clickName(){
    ...
    _fetchData() {
      var that = this;
       that.detail=[]
      let array=[
          {name:'C25',quantity:'316',receiveQuantity:'300',jcblStr:'0',jc:''},
          {name:'C20',quantity:'290',receiveQuantity:'260',jcblStr:'0',jc:''},
          {name:'C30',quantity:'289',receiveQuantity:'215',jcblStr:'0',jc:''},
          {name:'C40',quantity:'268',receiveQuantity:'159',jcblStr:'0',jc:''},
          {name:'C35',quantity:'420',receiveQuantity:'311',jcblStr:'0',jc:''},
      ]
      for (let index = 0; index < array.length; index++) {
            let element = array[index];
            element.jc=element.quantity-element.receiveQuantity
